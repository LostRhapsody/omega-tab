...
- [Command Palette](/guides/command-palette) - Learn keyboard-driven navigation with the command palette (`Ctrl+K`)
- [Search Suggestions](/guides/search-suggestions) - Understand how search suggestions work with Brave's suggestion API
